    ...
    <>
      <div className="max-w-[650px] flex flex-col">
        ...
        <p className="p-3 tracking-wider leading-8 text-[var(--secondary)] text-md md:text-lg">
          A Full Stack Developer and freelancer who has developed websites using React, Next.js, and
          the MERN Stack. I specialize in building high-performance, scalable web applications with
          a focus on UI/UX, backend efficiency, and optimization, delivering impactful digital
        ...
        <div className="mt-6 p-3 space-y-3 md:space-y-6">
          {workExperience.map((work) => (
            <div key={work.title} className="p-4 work bg-[var(--work-bg)] rounded-md">
              <h3 className="text-lg md:text-xl font-bold">{work.title}</h3>
              <p className="text-sm md:text-md text-[var(--secondary)]">
