...
const About = () =>{
  ...
  >
        ...
        <div className="max-w-[650px] flex  flex-col">
            ...
            <p className="mt-3 p-3 md:text-lg tracking-wide leading-7 text-[var(--secondary)]">I was born in Karur, Tamil Nadu, in a small village where most people couldn't even afford to study. But me? I had big dreams of becoming a businessman—just like my parents. There was just one small problem… I had zero business ideas.
